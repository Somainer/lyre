...
3. 在合理 checkpoint 调 `update_scratchpad(...)` 把中间状态写进 scratchpad，下次 wakeup 续作
...
mark_read / mailbox_react / query_task_status / read_memory /
...
- 长任务用 `update_scratchpad(...)` 在自己的 scratchpad 里维护中间状态，下次 wakeup 续作
