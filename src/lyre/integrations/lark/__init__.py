...
the dispatcher persona's seeded agent id (its ``display_name`` from
identity.md); ``@<agent_id>`` prefix or thread-continuity overrides.
Outbound goes through the standard ``channel_publish`` outbox kind
for kill-safe delivery.
